...
class MySQL
{
    ...
    private $db_host = "mysql.hostinger.com.br"; // server name
    private $db_user = "u144166463_mtapp"; // user name
    private $db_pass = "nEalQ6uSzi"; // password
    private $db_dbname = "u144166463_mtapp"; // database name
    ...
    // classes-internal variables - do not change
